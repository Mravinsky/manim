...
class Prueba10(GraphScene):
    ...
    def construct(self):
        ...
        ArmonicosPiano1 = [self.get_graph(f,self.approximation_color,x_min=-pi,x_max=pi)for f in self.ArmonicosPianoSuma]
        ArmonicosPiano2 = [self.get_graph(f,self.resultante_color,x_min=-pi,x_max=pi)for f in self.ArmonicosPianoSuma]
        ##
        ArmonicosGuitarra1 = [self.get_graph(f,self.approximation_color,x_min=-pi,x_max=pi)for f in self.ArmonicosGuitarraSuma]
        ArmonicosGuitarra2 = [self.get_graph(f,self.resultante_color,x_min=-pi,x_max=pi)for f in self.ArmonicosGuitarraSuma]
        ##
        ArmonicosCello1 = [self.get_graph(f,self.approximation_color,x_min=-pi,x_max=pi)for f in self.ArmonicosCelloSuma]
        ArmonicosCello2 = [self.get_graph(f,self.resultante_color,x_min=-pi,x_max=pi)for f in self.ArmonicosCelloSuma]
        ##
        ArmonicosPajaro1 = [self.get_graph(f,self.approximation_color,x_min=-pi,x_max=pi)for f in self.ArmonicosPajaroSuma]
        ArmonicosPajaro2 = [self.get_graph(f,self.resultante_color,x_min=-pi,x_max=pi)for f in self.ArmonicosPajaroSuma]
        ##
        ArmonicosPizzicato1 = [self.get_graph(f,self.approximation_color,x_min=-pi,x_max=pi)for f in self.ArmonicosPizzicatoSuma]
        ArmonicosPizzicato2 = [self.get_graph(f,self.resultante_color,x_min=-pi,x_max=pi)for f in self.ArmonicosPizzicatoSuma]
        ##
        ArmonicosVoz1 = [self.get_graph(f,self.approximation_color,x_min=-pi,x_max=pi)for f in self.ArmonicosVozSuma]
        ArmonicosVoz2 = [self.get_graph(f,self.resultante_color,x_min=-pi,x_max=pi)for f in self.ArmonicosVozSuma]
        ##
        ArmonicosTapa1 = [self.get_graph(f,self.approximation_color,x_min=-pi,x_max=pi)for f in self.ArmonicosTapaSuma]
        ArmonicosTapa2 = [self.get_graph(f,self.resultante_color,x_min=-pi,x_max=pi)for f in self.ArmonicosTapaSuma]
        ...
        ArmonicosPianoA = VGroup(*[ArmonicosPiano1[i]for i in range(8)])
        ArmonicosGuitarraA = VGroup(*[ArmonicosGuitarra1[i]for i in range(8)])
        ArmonicosCelloA = VGroup(*[ArmonicosCello1[i]for i in range(8)])
        ArmonicosPajaroA = VGroup(*[ArmonicosPajaro1[i]for i in range(8)])
        ArmonicosPizzicatoA = VGroup(*[ArmonicosPizzicato1[i]for i in range(8)])
        ArmonicosVozA = VGroup(*[ArmonicosVoz1[i]for i in range(8)])
        ArmonicosTapaA = VGroup(*[ArmonicosTapa1[i]for i in range(8)])
        ...
        #ArmonicosPiano2.clean_up_from_scene(self)
         

        
        self.play(
            ShowCreation(sines, run_time=2,remover=False),
            ShowCreation(sines2, run_time=2,remover=False),
            #TransformFromCopy(sines,Armonicos1a, run_time=5), # Aparecen todos desde abajo
            
            #ShowCreation(ArmonicosPianoA, run_time=2),

            ShowCreation(ArmonicosPianoA, run_time=2,remover=True), # Similar a TransformFromCopy?
        ...
        self.play(ReplacementTransform(ArmonicosPianoA,ArmonicosPianoA[7],run_time=1))
        
        self.play(ShowCreation(sines, run_time=2,remover=True),ShowCreation(sines2, run_time=2,remover=True),ShowCreation(ArmonicosGuitarraA, run_time=2,remover=True), rate_func=lambda t: linear (t),)
        self.play(ReplacementTransform(ArmonicosGuitarraA,ArmonicosGuitarraA[7],run_time=1))
        
        self.play(ShowCreation(sines, run_time=2,remover=True),ShowCreation(sines2, run_time=2,remover=True),ShowCreation(ArmonicosCelloA, run_time=2,remover=True), rate_func=lambda t: linear (t),)
        self.play(ReplacementTransform(ArmonicosCelloA,ArmonicosCelloA[7],run_time=1))
        
        self.play(ShowCreation(sines, run_time=2,remover=True),ShowCreation(sines2, run_time=2,remover=True),ShowCreation(ArmonicosPajaroA, run_time=2,remover=True), rate_func=lambda t: linear (t),)
        self.play(ReplacementTransform(ArmonicosPajaroA,ArmonicosPajaroA[7],run_time=1))
        
        self.play(ShowCreation(sines, run_time=2,remover=True),ShowCreation(sines2, run_time=2,remover=True),ShowCreation(ArmonicosPizzicatoA, run_time=2,remover=True), rate_func=lambda t: linear (t),)
        self.play(ReplacementTransform(ArmonicosPizzicatoA,ArmonicosPizzicatoA[7],run_time=1))
        
        self.play(ShowCreation(sines, run_time=2,remover=True),ShowCreation(sines2, run_time=2,remover=True),ShowCreation(ArmonicosVozA, run_time=2,remover=True), rate_func=lambda t: linear (t),)
        self.play(ReplacementTransform(ArmonicosVozA,ArmonicosVozA[7],run_time=1))
        
        self.play(ShowCreation(sines, run_time=2,remover=True),ShowCreation(sines2, run_time=2,remover=True),ShowCreation(ArmonicosTapaA, run_time=2,remover=True), rate_func=lambda t: linear (t),)
        self.play(ReplacementTransform(ArmonicosTapaA,ArmonicosTapaA[7],run_time=1))
